    ...
    return (
        ...
        <div>
            ...
            <div className="user">
                    ...
                    <input {...register("user", { required: true, maxLength: 20, pattern: /^[A-Za-z\s]+$/i })} value={formData.user || 'user'} />
                ...
                <div>
                    ...
                    <input {...register("location", { required: true,pattern: /^[A-Za-z\s]+$/i })} value={formData.location || 'location'} />
                ...
                <div className="description">
                    ...
                    <input {...register("description", { required: true, pattern: /^[A-Za-z\s]+$/i })}  value={formData.description || 'description'} />
                ...
                <div className="shortdescription">
                    ...
                    <input {...register("shortDescription", { required: true})}  value={formData.shortDescription || 'sdescription'}/>
                    {errors.shortDescription?.type === 'required' && "Needs to be filled out"}
                </div>

                <div className="Date">
                    <label htmlFor="Date">Date:</label>
                    <input {...register("date", { required: true })}  value={formData.date || '10/10/12'}/>
                    {errors.location?.type === 'required' && "Needs to be filled out"}
                </div>
